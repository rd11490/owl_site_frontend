...
@Component({
  ...
  template: `
    <div class="metric-selector">
      <mat-radio-group [formControl]="metricControl" class="metric-radio-group" aria-label="Select metric">
        <mat-radio-button *ngFor="let metric of metrics" [value]="metric" class="metric-radio-button">
          {{ metric }}
        </mat-radio-button>
      </mat-radio-group>
    </div>
